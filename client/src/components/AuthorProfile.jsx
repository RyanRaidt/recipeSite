          ...
          <div id="userPicAndDetailsContainer">
            <div id="profileBorder">
              <div id="userProfilePicContainer">
                <img
                  src={
                    authorInfo.profileUrl?.startsWith("http")
                      ? authorInfo.profileUrl
                      : `${API_URL}${authorInfo.profileUrl}` 
                  }
                  alt="User Profile"
                />
              </div>
            ...
            <div id="userDetailsContainer">
              ...
              <p>
                <strong>Name:</strong> {authorInfo.name}
              </p>
              <p>
                <strong>Email:</strong> {authorInfo.email}
              </p>
              <p>
                <strong>Title:</strong> {authorInfo.userTitle || "Not provided"}
              </p>
              <p>
                <strong>Bio:</strong> {authorInfo.bio || "Not provided"}
              </p>
